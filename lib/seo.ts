export function generateLocalBusinessSchema(settings: {
  ...
  return {
    ...
    description: 'Professional residential and commercial electrical installation, repair, house wiring, and 24/7 emergency electrical services in Kathmandu Valley by Sanjeet Mishra.',
    url: baseUrl,
    ...
    founder: {
      '@type': 'Person',
      name: settings.ownerName || 'Sanjeet Mishra',
...
export function generateBlogPostSchema(post: {
  ...
  return {
    ...
    image: post.imageUrl || `${baseUrl}/logo.png`,
    author: {
      '@type': 'Person',
      name: post.author || 'Sanjeet Mishra',
