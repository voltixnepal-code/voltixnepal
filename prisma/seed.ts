...
async function main() {
  ...
  await prisma.websiteSettings.upsert({
    ...
    create: {
      ...
      footerText: 'Professional electrical installation, emergency repair, and maintenance services across Kathmandu Valley. Safety, punctuality, and quality guaranteed by Sanjeet Mishra.',
  ...
  const sections = [
    ...
    { sectionKey: 'about', label: 'About Sanjeet Mishra', isEnabled: true, sortOrder: 5 },
  ...
  const testimonials = [
    {
      ...
      rating: 5,
      content: 'Had a severe MCB tripping issue in our main distribution board at 8 PM. Sanjeet arrived within 45 minutes, found a burned wire inside the wall conduit, and fixed it safely. Very polite, clean work and fair pricing.',
      date: 'February 2026',
      photoUrl: null,
      isApproved: true,
    },
    ...
    },
    {
      ...
      rating: 5,
      content: 'We had persistent electrical shock on our metal sink caused by improper earthing. Sanjeet installed a proper chemical ground pit and brought earth resistance down below 3 Ohms. Problem completely resolved.',
      date: 'December 2025',
      photoUrl: null,
      isApproved: true,
    },
...
Always choose **Pure Sine Wave** inverters over Square Wave models to protect modern electronic gadgets, fans, and televisions from humming noises and PCB damage. Contact us for professional installation with heavy-gauge cables.`,
      ...
      metaDescription: 'Calculate the right inverter VA and tubular battery AH capacity for your home or office in Nepal. Practical guide by electrician Sanjeet Mishra.',
      isPublished: true,
...
For thorough safety inspections in Kathmandu, Lalitpur, or Bhaktapur, schedule an appointment with VoltixNepal.`,
      ...
      metaDescription: 'Prevent house fires and shocks with these 7 practical electrical safety tips from Kathmandu electrician Sanjeet Mishra.',
      isPublished: true,
  ...
  await prisma.notification.create({
    data: {
      ...
      message: 'System initialized successfully with initial services, hero slides, and business settings for Sanjeet Mishra.',
      link: '/admin',
      isRead: false,
    },
  });
